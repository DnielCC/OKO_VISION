...
<body class="min-h-screen">
    ...
    <aside id="sidebar" class="sidebar glassmorphism w-64 min-h-screen fixed left-0 top-0 z-40 transition-transform duration-300">
        <div class="p-6">
            ...
            <!-- Navigation Menu -->
            <nav class="space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-item flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span>Dashboard</span>
                </a>
                
                <a href="<?php echo e(route('alertas')); ?>" class="sidebar-item flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white">
                    <i class="fas fa-exclamation-triangle w-5"></i>
                    <span>Alertas</span>
                </a>
                
                <a href="<?php echo e(route('usuarios')); ?>" class="sidebar-item flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white">
                    <i class="fas fa-users w-5"></i>
                    <span>Usuarios</span>
                </a>
                
                <a href="<?php echo e(route('reportes')); ?>" class="sidebar-item flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white">
    ...
    <main class="main-content md:ml-64 min-h-screen">
        ...
        <header class="glassmorphism border-b border-gray-700">
            <div class="px-6 py-4 flex items-center justify-between">
                <h2 class="text-2xl font-bold text-white"><?php echo e($title ?? 'Dashboard'); ?></h2>
...
<?php /**PATH /home/dnts/Desktop/OKO_VISION/Laravel_Admin/resources/views/layouts/app.blade.php ENDPATH**/ ?>